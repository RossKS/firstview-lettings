...
<head>
  ...
  <link rel="shortcut" type="image/png" href="../images/keys-logo.png">
</head>

<body>
  <div class="wrap">
    <header style="display:flex" role="banner">
      <div><a href="../firstview-lettings-home.html"><img src="../images/main-logo.jpg" id="main-logo"></a></div>
      <nav class="nav flex-row flex-sm-row" role="banner">
        <a class="flex-sm-fill text-sm-center nav-link active" href="../firstview-lettings-home.html">Home</a>
        ...
        <div class="btn-group" id="tenants">
          <a type="button" class="btn" href="../tenant-services.html">Tenants</a>
        ...
        <div class="btn-group" id="landlords">
          <a type="button" class="btn" href="../landlord-services.html">Landlords</a>
          <!-- <button type="button" class="btn dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <span class="sr-only">Toggle Dropdown</span>
          </button>
          <div class="dropdown-menu">
        ...
        <a id="contact" class="hide-sm flex-sm-fill text-sm-center nav-link" href="#">Contact</a>
      </nav>
    </header>
          ...
          <div class="contact-form">
            ...
            <form class="contact-form" action="<?= test_input($_SERVER['PHP_SELF']); ?>" method="post" id="form">
              ...
              <p>
                ...
                <input type="email" id="email" name="email" placeholder="Please enter a valid email address (johnsmith@example.com)" value="<?= $address ?>" tabindex="2" required title="Please enter a valid email address">
  ...
  <footer class="main-footer" role="contentinfo">
    ...
    <div>
      ...
      <a href="../legal.html" tabindex="14">Privacy Policy</a>
    </div>

    <p class="webdev">Crafted by Firstview Lettings Ltd</p>
  </footer>
  <script>
    var d = new Date();
